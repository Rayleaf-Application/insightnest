defmodule InsightnestWeb.OnboardingLive do
    ...
    if Accounts.onboarded?(member) do
      ...
      {:ok,
       assign(socket,
         ...
         username: "",
         checking: false,
         # nil = not checked, true/false = result
         available: nil,
         error: nil,
    ...
    case Accounts.set_username(member, username) do
      ...
      {:error, reason} ->
        {:noreply,
         ...
         |> assign(error: Error.message(reason))}
    end
  end
  ...
  def render(assigns) do
    ...
    <div class="min-h-screen flex items-center justify-center px-4">
      <div class="w-full max-w-sm animate-fade-up">
        ...
        <div
          :if={@error}
          class="mb-4 px-4 py-3 rounded-lg border border-red-800/60 bg-red-950/50 text-red-300 text-sm"
        >
          {@error}
        </div>
  ...
  defp input_border_style(true),
    do: "border-color: #166534; box-shadow: 0 0 0 1px rgba(22,101,52,0.3);"

  defp input_border_style(false),
    do: "border-color: #991b1b; box-shadow: 0 0 0 1px rgba(153,27,27,0.3);"
end
