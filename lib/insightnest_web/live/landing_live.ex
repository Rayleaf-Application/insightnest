      ...
      <footer class="border-t border-stone-800/60">
        <div class="max-w-lg mx-auto px-4 py-5 flex flex-col items-center gap-3">
          <div class="flex items-center gap-6">
            <a href="#" title="Mastodon" class="text-stone-600 hover:text-stone-400 transition-colors" aria-label="Mastodon">
            ...
            <a href="#" title="Matrix" class="text-stone-600 hover:text-stone-400 transition-colors" aria-label="Matrix">
            ...
            <a href="#" title="GitHub" class="text-stone-600 hover:text-stone-400 transition-colors" aria-label="GitHub">
            ...
            <a href="#" title="Discord" class="text-stone-600 hover:text-stone-400 transition-colors" aria-label="Discord">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
