defmodule InsightnestWeb do
  ...
  def static_paths,
    do: ~w(assets fonts images favicon.ico favicon.svg robots.txt admin manifesto.html)
  ...
  def controller do
    quote do
      ...
      use Gettext, backend: InsightnestWeb.Gettext
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        router: InsightnestWeb.Router,
        statics: InsightnestWeb.static_paths()
    end
  end
