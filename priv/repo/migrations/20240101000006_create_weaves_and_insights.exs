defmodule Insightnest.Repo.Migrations.CreateWeavesAndInsights do
  ...
  def change do
    ...
    create table(:insights, primary_key: false) do
      ...
      # JSONB array of body blocks
      add :body, :map, null: false
      # JSONB contributor shares
      add :contributors, :map, null: false
    ...
    create table(:weave_contributions, primary_key: false) do
      ...
      add :contribution_id, references(:contributions, type: :binary_id, on_delete: :delete_all),
        null: false
    end
